...
const PROVIDERS = [
  ...
  },
  {
    ...
    icon: '𝕏',
    color: '#000000',
    description: 'Elon Musk\'s AI company with Grok models and real-time X data access',
    features: [
      'Chat completion',
      'Code generation',
      'Vision',
  ...
  },
  {
    ...
    icon: '🌪️',
    color: '#f2a73b',
    description: 'French AI company with Mistral and Mixtral mixture-of-experts models',
    features: [
      'Chat completion',
      'Code generation',
      'Function calling',
  ...
  },
  {
    ...
    icon: '🦙',
    color: '#0668e1',
    description: 'Meta\'s open-source Llama models, available via various cloud providers',
    features: [
      'Chat completion',
      'Code generation',
      'Vision',
  ...
  },
  {
    ...
    icon: '🔍',
    color: '#00a6fb',
    description: 'Chinese AI company with highly competitive pricing and strong coding capabilities',
    features: [
      'Chat completion',
      'Code generation',
      'Reasoning',
...
const OPENAI_MODELS = [
  ...
  },
  {
    ...
    tags: ['flagship'],
    limits: { contextWindow: 8191, maxOutputTokens: 0 },
...
const ANTHROPIC_MODELS = [
  {
    ...
    status: 'stable',
    capabilities: ['text-generation', 'chat', 'vision', 'function-calling', 'streaming', 'json-mode', 'mcp-servers'],
    tags: ['fast', 'cost-effective'],
  ...
  },
  {
    ...
    status: 'stable',
    capabilities: ['text-generation', 'chat', 'vision', 'function-calling', 'streaming', 'json-mode', 'code-generation', 'mcp-servers'],
  ...
  },
  {
    ...
    status: 'stable',
    capabilities: ['text-generation', 'chat', 'vision', 'function-calling', 'streaming', 'json-mode', 'reasoning', 'code-generation', 'mcp-servers'],
...
const GOOGLE_MODELS = [
  ...
  },
  {
    ...
    tags: ['deprecated'],
    limits: { contextWindow: 32760, maxOutputTokens: 8192 },
  ...
  },
  {
    ...
    limits: { contextWindow: 16384, maxOutputTokens: 2048 },
  ...
  },
  {
    ...
    tags: ['deprecated'],
    limits: { contextWindow: 8196, maxOutputTokens: 1024 },
...
const XAI_MODELS = [
  {
    ...
    limits: { contextWindow: 131072, maxOutputTokens: 4096 },
  ...
  },
  {
    ...
    status: 'beta',
    capabilities: ['text-generation', 'chat', 'vision', 'code-generation', 'function-calling', 'streaming'],
...
const MISTRAL_MODELS = [
  ...
  },
  {
    ...
    limits: { contextWindow: 32000, maxOutputTokens: 8192 },
  ...
  },
  {
    ...
    status: 'stable',
    capabilities: ['text-generation', 'chat', 'code-generation', 'streaming'],
    tags: ['coding', 'fast'],
    limits: { contextWindow: 32000, maxOutputTokens: 8192 },
    pricing: { input: 0.2, output: 0.6 },
...
const META_MODELS = [
  ...
  },
  {
    ...
    status: 'stable',
    capabilities: ['text-generation', 'chat', 'code-generation', 'function-calling', 'streaming', 'reasoning'],
  ...
  },
  {
    ...
    status: 'stable',
    capabilities: ['text-generation', 'chat', 'vision', 'code-generation', 'streaming'],
...
const DEEPSEEK_MODELS = [
  ...
  },
  {
    ...
    status: 'stable',
    capabilities: ['text-generation', 'chat', 'reasoning', 'code-generation', 'streaming'],
