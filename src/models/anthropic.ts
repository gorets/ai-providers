...
export const ANTHROPIC_MODELS: ModelInfo[] = [
  ...
  {
    id: 'claude-opus-4-5',
    aliases: ['claude-opus-4-5-20251124', 'claude-opus-4.5', 'claude-opus'],
    ...
    tags: ['flagship', 'reasoning', 'multimodal', 'coding', 'computer-use'],
    limits: {
      contextWindow: 200000,
  ...
  },
  {
    ...
    tags: ['deprecated', 'reasoning', 'multimodal', 'coding'],
    limits: {
      contextWindow: 200000,
      maxOutputTokens: 8192,
    },
